package org.josht.starling.foxhole.examples.helloWorld
{
	...
	/**
	 * A very basic example to create a Button with Foxhole for Starling.
	 */
	public class Main extends Sprite
	{
		...
		/**
		 * The Foxhole Button control that we'll be creating.
		 */
